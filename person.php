    ...
    <main role="main" class="container content person">
        <div class="row header-intro">
            <div class="col-12 col-md-6">
                <section id="introduction" class="introduction-section d-flex align-items-center">
                    <div class="prof-img align-self-start">
                        <img class="img-fluid" src="assets/images/user-image.png" alt="User Image">
                    </div>
                    <div class="prof-desc">
                        <div class="prof-desc-name">
                            <h3 class="heading font-weight-bold">William Frairs</h3>
                        </div>
                        <div class="prof-desc-detail">
                            <div class="prof-desc-misc">
                                <span><span class="font-weight-bold">Age:</span> 49</span> &nbsp; <span><img
                                            src="assets/images/flag-uk.png" alt="Country Flag"> British</span>
                            </div>
            ...
            <div class="col-12 col-sm-6 col-md-1">
                <div class="d-flex flex-md-column align-items-center justify-content-center h-100">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div id="donut-chart" class="donut-chart w-100 mt-n1"></div>
            </div>
            <div class="col-12 col-md-2">
                <section id="trans-amount"
                         class="trans-amount-section d-flex justify-content-center align-items-center align-items-md-end flex-column h-100">
                    <!--                    <div class="trans-amount-amt mb-2">-->
                    <!--                        <h4 class="crc-amount mb-0 mt-n1 ">&#163;<span class="">1,880,993</span></h4>-->
                    <!--                    </div>-->
                    <div class="trans-amount-misc d-flex flex-column">
                        <div class="d-inline-flex justify-content-between justify-content-md-end">
                            <span class=""> DIRECTORSHIPS </span>
                            <span class="ml-2 s-block text-right">36</span>
                        </div>
                        <div class="d-inline-flex justify-content-between justify-content-md-end mt-2">
                            <span class=""> TRANSACTIONS </span>
                            <span class="ml-2 s-block text-right">3</span>
                        </div>
                    </div>
                </section>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="toggle-section d-inline-flex">
                                            ...
                                            <h5 class="mb-0 heading border-bottom brd-custom">
                                                <span class="heading-title font-weight-bold"> Aldtech </span>
                                            </h5>
                                            <div class="link-text d-flex align-items-center justify-content-between flex-column flex-sm-row ml-2">
                                                ...
                                                <div class="more-wrapper w-100">
                                                    <div class="more-info w-100 mt-1">
                                                        <div class="d-flex align-items-center justify-content-center justify-content-lg-end ">
                                                            <span class="trade-count">4</span>&nbsp;<span
                                                                    class="text-display">Trades</span>&nbsp;|&nbsp;<span
                                                                    class="text-display">Latest:</span>&nbsp;<span
                                                                    class="latest-date">Feb 13</span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <span class="score-card-wrapper" style="display: none">
                                                                <span class="score-card"><span>Scores:</span>
                                                                    <span class="score-card-item score-card-buy"><span
                                                                                class="font-weight-bold"> Buy - 23 </span> / 100 </span>
                                                                    <span class="score-card-item score-card-sell"><span
                                                                                class="font-weight-bold"> Sell - 40 </span> / 100 </span>
                                                                </span>
                                                            </span>
                                                            <span class="show-more more ml-auto" style="display: none">
                                                                <span class="d-flex align-items-center">
                                                                <span>Show</span>&nbsp;<span
                                                                            class="txt-change">More</span>&nbsp;<i
                                        ...
                                        <div class="w-50 w-md-25 ">
                                            <div class="md-form my-0 ">
                                                ...
                                                <input placeholder="From" type="date" id="fromDate" name="fromDate"
                                                       class="form-control datepicker my-0 border-bottom-0 text-center text-md-left">
                        ...
                        <div class="chart-block-com trade-block mt-0 p-3">
                            <div class="chart-box">
                                <div class="chart-header d-flex justify-content-between align-items-center flex-column flex-lg-row">
                                    <h4 class="heading font-weight-light w-100 w-lg-50 text-left">Trade History <span>(all stocks)</span></h4>
                                        ...
                                        <div class="w-100 text-center">
                                            ...
                                            <div class="disall-switch switcher-box d-flex justify-content-center align-items-center w-100">
                                                <div class="switch w-100">
                                                    <label class="mb-0 w-100 flex justify-content-center align-items-center">
                                                        <span class="switchStateL font-weight-bold">Discretionary </span>
                                                        <input type="checkbox"> <span class="lever"></span> <span
                                                                class="switchStateR "> All</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
