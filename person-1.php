    ...
    <main role="main" class="container content person">
        <div class="row header-intro">
                        ...
                        <div class="prof-desc-title d-flex align-items-center flex-column flex-md-row">
                            ...
                            <div id="trans-amount"
                                ...
                                <div class="d-flex flex-column justify-content-between align-items-center">
                                    <span class="font-weight-bold">TRADED SINCE</span>
                                    <span class="s-block text-center font-weight-normal">Feb 16</span>
                                </div>
                                <div class="d-flex flex-column justify-content-between align-items-center">
            ...
            <div class="col-6 col-lg-2">
                <div id="score-chart" class="score-chart chart-high"></div>
            ...
            <div class="col-6 col-lg-2">
                <div id="donut-chart" class="donut-chart chart-high"></div>
            </div>
            ...
            <div class="col-12 my-lg-0">
                ...
                <div class="collapsible-block">
                    ...
                    <div class="accordion md-accordion" id="accordionCompanyName" role="tablist"
                        ...
                        <div class="card">
                            <!-- Card header -->
                            <div class="card-header px-2 py-0" role="tab" id="headingCompanyName">
                                <div class="row">
                                    <div class="col-lg-7">
                                        <div class="toggle-section d-inline-flex flex-wrap flex-md-nowrap">
                                            <a class="director-toggler position-relative" data-toggle="collapse"
                                               data-parent="#accordionCompanyName" aria-expanded="false"
                                               href="#collapseCompanyName" aria-controls="collapseCompanyName">
                                                    ...
                                                    <div class="show-more-block mt-1">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <span class="score-card-wrapper" style="display: none">
                                                                <span class="score-card d-inline-flex flex-column flex-sm-row d-lg-block text-left">
                                                                    <span>Scores:</span>
                            ...
                            <div id="collapseCompanyName" class="collapse" role="tabpanel"
                                 aria-labelledby="headingCompanyName" data-parent="#accordionCompanyName">
                                                                ...
                                                                <div class="return-analysis-block return-analysis-center w-100 w-lg-70 mx-3 px-2 pt-1 pb-2 my-2 my-lg-0 border brd-custom">
                                                                    <div class="return-analysis-header d-flex justify-content-between align-items-center">
                                                                        ...
                                                                        <span class="custom-control custom-checkbox form-check ">
                                                                            <input type="checkbox" data-name="adjusted"
                                                                        ...
                                                                        <span class="custom-control custom-checkbox form-check ml-2">
                                                                            <input type="checkbox" data-name="weighted"
                                                                                ...
                                                                                <table class="table table-bordered text-center my-0">
                                                                                    <tr class="bg-white ">
                                                                                        ...
                                                                                        <th class="sm-heading font-weight-bold">
                                                                                            <span>6 MONTH <span
                                                                                                        class="val-abs val-abs-buy">ABSOLUTE </span>RETURN</span>
                                                                                        </th>
                                                                                        <th class="sm-heading font-weight-bold">
                                                                                            <span> TRADES </span>
                                                                                        </th>
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table table-bordered text-center mb-0">
                                                                                    <tr class="bg-white ">
                                                                                        ...
                                                                                        <th class="sm-heading font-weight-bold">
                                                                                            6 MONTH <span
                                                                                                    class="val-abs val-abs-sell">ABSOLUTE </span>
                                                                                            RETURN
                                                                                        </th>
                                                                                        <th class="sm-heading font-weight-bold">
                                                                                            TRADES
                                        ...
                                        <div class="col-lg-6">
                                            <div class="trading-block trading-summary d-flex flex-column h-100">
                                                ...
                                                <div id="trade-summary"
                                                     ...
                                                     style="max-height: 200px; overflow-y: hidden; overflow-x: visible;">
                                                ...
                                                <div class="sum-footer pt-1 mt-auto" style="display: none">
                                                    ...
                                                    <div class="sum-link">
                                                        <a class="linkHistory" href="#trade_history"
                                                           title="Trade History">See all William
        ...
        <div class="row chart-section mt-2">
            ...
            <div class="col-12">
                ...
                <div class="my-2">
                    ...
                    <div class="collapsible-block investment-timeline my-2">
                        <!--Accordion wrapper-->
                        <div class="accordion md-accordion" id="accordionInvestmentTimeline" role="tablist"
                            ...
                            <div class="card py-2">
                                <!-- Card header -->
                                <div class="card-header px-2 py-0" role="tab" id="headingInvestmentTimeline">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="toggle-section d-inline-flex align-items-center">
                                                <a class="director-toggler position-relative" data-toggle="collapse"
                                                ...
                                                <h4 class="mb-0 heading text-truncate d-inline-block">
                                                    <span class="heading-title h-100 font-weight-bold">Investment Timeline</span>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="w-100 investment-timeline-switch mt-2" style="display: none;">
                                                <div class="switcher-block mx-auto ml-md-auto">
                                                    <div class="investment-switch switcher-box d-flex justify-content-md-end justify-content-center align-items-center ">
                                                        <div class="switch">
                                                            <label class="mb-0 d-flex justify-content-between align-items-center">
                                                                ...
                                                                <span class="switchStateR">All Trades</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="collapseInvestmentTimeline" class="collapse" role="tabpanel"
                                    ...
                                    <div class="card-body py-2">
                                        <div class="investment-timeline">
                                            <div class="chart-block-com investment-block mt-0">
                                                <div class="chart-box">
                                                    <div class="position-relative mt-4 mt-md-0">
                                                        <div class="position-absolute index-element w-auto d-flex align-items-center justify-content-center flex-wrap flex-md-row flex-md-nowrap">
                                                            <div id="share-price"
                                                                 class="trade-history-filter w-100 w-md-50 d-flex align-items-center">
                                                        ...
                                                        <div id="investment-chart-table"
                                                             class="investment-timeline-table mt-2"></div>
                                                    </div>
                    ...
                    <div class="collapsible-block trade-history my-2">
                        <!--Accordion wrapper-->
                        <div class="accordion md-accordion" id="accordionTradeHistory" role="tablist"
                            ...
                            <div class="card py-2">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="toggle-section d-inline-flex align-items-center">
                                                ...
                                                <h4 class="mb-0 heading text-truncate d-inline-block">
                                                    <span class="heading-title h-100 font-weight-bold">Trade History <span>(All stocks)</span></span>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="w-100 trade-history-switch" style="display: none;">
                                                <div class="switcher-block d-flex align-items-center justify-content-md-end justify-content-center">
                                                        ...
                                                        <div class="disall-switch switcher-box d-flex justify-content-center align-items-center w-100">
                                                            <div class="switch w-100">
                                                                <label class="mb-0 w-100 d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <input type="checkbox">
                                                                    <span class="lever"></span>
                                                                    <span class="switchStateR text-left">All</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="rotate-img rounded-bottom align-self-end">
                                                        <i class="far fa-file-excel fa-2x infop1"
                                                           aria-hidden="true"></i>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div id="collapseTradeHistory" class="collapse" role="tabpanel"
                                     aria-labelledby="headingTradeHistory" data-parent="#accordionTradeHistory">

                                    <div class="card-body py-2">

                                        <div id="trade_history" class="trade-history">
                                            <div class="chart-block-com trade-block mt-0 p-3">
                                                        ...
                                                        <div class="trade-filter w-100 d-flex flex-wrap align-items-center">
                                                                    ...
                                                                    <span class="sort-select custom-select-option">
                                                                        ...
                                                                        <select class=" mdb-select md-form colorful-select dropdown-primary"
                                                                            ...
                                                                            <!-- <option code='asc' value='9'>Change : Low - High</option>
                                                                                 <option code='desc' value='9'>Change: High - Low</option>-->                                                                            <!-- <option code='asc' value='28'>TSI: Low - High</option>
                                                                ...
                                                                <div id="filter"
                                                                    ...
                                                                    <div class="filter-select custom-select-option">
                                                                        ...
                                                                        <select id="filter-select" multiple="multiple"
                                                                            ...
                                                                            <option value="Transaction Date">Transaction
                                                                                Date
                                                                            </option>
                                                                            <option value="Transaction Amount">
                                                                                Transaction Amount
                                                                            </option>
                                                                            <option value="Value">Value</option>
                                                                            <option value="Note">Note</option>
                                                                            <option value="Source">Source</option>
                                                                            <option value="Cluster Trade">Cluster
                                                                                Trade
                                                                            </option>
                                                                            <option value="Signal Note">Signal Note
                                                                            </option>
                                                                            ...
                                                                            <option value="Adj 1 Year">Adj 1 Year
                                                                            </option>
                                                                            <option value="18 Mon">18 Mon</option>
                                                                            <option value="Adj 18 Mon">Adj 18 Mon
                                                                            </option>
                                                                            <option value="2 Year">2 Year</option>
                                                                            <option value="Adj 2 Year">Adj 2 Year
                                                                            </option>
                                                                            <option value="Holding Change">Holding
                                                                                Change
                                                                            </option>
                                                                            <option value="Holding Sii">Holding Sii
                                                                            </option>
                                                                            <option value="Conviction Rating">Conviction
                                                                                Rating
                                                                            </option>
                                                            ...
                                                            <div id="trades-meta" class="w-55">
                                                                <span class="total-trades-all hidden-summary h-100 w-100 flex-wrap d-flex text-wrap align-items-center"
                                                                    ...
                                                                    <span class="trade-selected-amount-all" style=""
                                                                          title="">
                                                                        ...
                                                                        <span class="total-selected-trades" title=""
                                                                              style="display:none">
                                                                            <span class="trade-selected-count" title="">11 Trades Selected: </span>
                                                                            <span class="trade-selected-amount buy-color"
                                                                                  title=""> &nbsp;Net 86,000 shares acquired <span
                                                                                        class="buycolor">[+$145,166]</span>
                                                                            </span>
                                                                            <span class="notrades"
                                                                                  style="display:none;">No Trades Selected</span>
                                                                        </span>
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div id="scroll-wrapper2"
                                                            ...
                                                            <table id="example" class="display trade-table w-100">
                                                                ...
                                                                <tr id="lower-head">
                                                                    ...
                                                                    <!--</th>-->
                                                                    <th class="persons group-insider sorting_disabled ui-state-default custom-hidden"
                                                                        id="director-header" rowspan="1" colspan="1"
                                                                        aria-label="Director">
                                                                    ...
                                                                    <th class="title group-insider sorting_disabled ui-state-default custom-hidden dt-border-lr"
                                                                        id="title-header" rowspan="1" colspan="1"
                                                                        aria-label="Title">
                                                                        <div class="DataTables_sort_wrapper">
                                                                    ...
                                                                    <th class="tdate group-tdetails sorting_disabled ui-state-default custom-hidden "
                                                                        id="trade-date-header" rowspan="1" colspan="1"
                                                                        aria-label="Transaction Date">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span class="invisible"
                                                                                  title="Transaction Date">Transaction&nbsp;Date</span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                                        </div>
                                                                    </th>
                                                                    <th class="type group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="trade-type-header" rowspan="1" colspan="1"
                                                                        aria-label="Type">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span class="invisible"
                                                                                  title="Transaction type">Type</span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                                        </div>
                                                                    </th>
                                                                    <th class="amount amount-header group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="trade-amount-header" rowspan="1" colspan="1"
                                                                        aria-label="Amount">
                                                                        <div class="DataTables_sort_wrapper">
                                                                    ...
                                                                    <th class="at at-header group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="at-header" rowspan="1" colspan="1"
                                                                        aria-label="">
                                                                        <div class="DataTables_sort_wrapper">
                                                                    ...
                                                                    <th class="price group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="price-header" title="Price of Trade"
                                                                        rowspan="1"
                                                                    ...
                                                                    <th class="note group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="note-header" rowspan="1" colspan="1"
                                                                        aria-label="Note">
                                                                        <div class="DataTables_sort_wrapper">
                                                                    ...
                                                                    <th class="source group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="source-header" rowspan="1" colspan="1"
                                                                        aria-label="Source">
                                                                        <div class="DataTables_sort_wrapper">
                                                                    ...
                                                                    <th class="tblTransaction-isCluster group-tdetails sorting_disabled ui-state-default custom-hidden"
                                                                        id="tblTransaction-header" rowspan="1"
                                                                        colspan="1"
                                                                    ...
                                                                    <th class="tblsignal-SignalReason group-tdetails sorting_disabled ui-state-default custom-hidden "
                                                                        id="tblsignal-header" rowspan="1" colspan="1"
                                                                        aria-label="">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span class="invisible"></span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                                    ...
                                                                    <th class="value value-header visibled group-tdetails sorting_disabled ui-state-default dt-border-lr custom-hidden"
                                                                        id="value-header" title="numeric-comma"
                                                                        rowspan="1" colspan="1"
                                                                        aria-label="Currency can be changedin settings&quot;>Value £">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span title="Value of Transaction.<BR>Currency can be changed<br>in settings"
                                                                                  class="invisible">Value&nbsp;£</span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                                        </div>
                                                                    </th>
                                                                    ...
                                                                    <th class="holding_change group-holding sorting_disabled ui-state-default"
                                                                        id="holding_change" rowspan="1" colspan="1"
                                                                    ...
                                                                    <th title="% of Shares on Issue held, not displayed below 0.1%"
                                                                        ...
                                                                        id="sii-col" rowspan="1" colspan="1"
                                                                        aria-label="%Sii">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span>%Sii</span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                                    ...
                                                                    <th class="rating group-analysis sorting_disabled ui-state-default"
                                                                        ...
                                                                        id="rating-header" rowspan="1" colspan="1"
                                                                    ...
                                                                    <th class="salary-data group-analysis sorting_disabled ui-state-default"
                                                                        ...
                                                                        id="salary-header" rowspan="1" colspan="1"
                                                                        aria-label="%Salary">
                                                                        <div class="DataTables_sort_wrapper">
                                                                            <span>%Salary</span>
                                                                            <span class="DataTables_sort_icon"></span>
                                                ...
                                                <span title="Senior Officer:Investment Manager<br/>(Investment) ">P:Inv'ment
                                                    Mgr</span>
                                                                    ...
                                                                    <td class=" type"><span
                                                                                class="buysell-span sell_type"><b
                                                ...
                                                <span class="newfilter fa fa-filter filter-blue"
                                                      title="Filter page for this Director"></span>
                                                                        <a class="persontooltip  personname"
                                                                           dir="839764" id="458750"
                                                ...
                                                <span class="buysell-span sell_type"><b title=" Sell ">Sell</b> <span
                                                            ...
                                                            style="vertical-align:middle;"></span>
                                                                    ...
                                                                    <td class="amount visibled">
                                                                        <span class="amount_down"
                                                                              title="Ordinary Shares ">50,000</span>
                                                                    </td>
                                                                    <td class=" at">
                                                                        <span class="at"> @</span>
                                                                    </td>
                                                ...
                                                <span class="fa fa-users" id="8141491"
                                                      title="Transaction Detail - Cluster Trade"></span>
                                                                    ...
                                                                    <td class="tblsignal-SignalReason visibled">
                                                                        <span class="fas fa-folder-open infop1"
                                                                              title=""></span>
                                                                    </td>
                                                                    <td class="value visibled">
                                                <span class="value_down"
                                                ...
                                                <span class="buysell-span sell_type"><b title=" Sell ">Sell</b> <span
                                                            ...
                                                            style="vertical-align:middle"></span>
                                                                    ...
                                                                    <td class="amount visibled">
                                                                        <span class="amount_down"
                                                                              title="Ordinary Shares ">20,000</span>
                                                                    </td>
                                                                    <td class=" at"><span class="at"> @</span></td>
                                                                    <td class=" price">£<span
                                                ...
                                                <span class="buysell-span sell_type"><b title=" Sell ">Sell</b> <span
                                                            ...
                                                            style="vertical-align:middle"></span></span>
                                                                    ...
                                                                    <td class="amount visibled">
                                                                        <span class="amount_down"
                                                                              title="Ordinary Shares ">10,000</span>
                                                                    </td>
                                                                    <td class=" at"><span class="at"> @</span></td>
                                                                    <td class=" price">£<span
                                                ...
                                                <span title="Senior Officer:Investment Manager<br/>(Investment) ">P:Inv'ment
                                                    Mgr</span>
                                                                    ...
                                                                    <td class=" type"><b
                                                                                title=" Subscribe to new<br>issue ">Subs</b>
                                                                    </td>
                                                                    <td class="amount visibled">
                                                <span class="amount_up"
                                                ...
                                                <span class="value_up"
                                                      title="<b>£3,811,053</b><br><b>$4,923,452</b><BR><b>€4,351,807 </b><br/>Display currency can be changed in Account Settings ">$4,923,452</span>
                                                                    ...
                                                                    <td class="adj-1-mo hiddem"><span
                                                                                style="color:#F44236">-5%</span></td>
                                                                    <td class="6-mo  c-6-mo visibled"></td>
                                                                    <td class="adj-6-mo hiddem"></td>
                                                                    <td class="9-mo c-9-mo hiddem"></td>
                                                                    <td class="adj-9-mo hiddem"></td>
                                                ...
                                                <span class="buysell-span sell_type"><b title=" Sell ">Sell</b> <span
                                                            ...
                                                            style="vertical-align:middle"></span>
                                                                    ...
                                                                    <td class="source visibled"><a target="blank"
                                                                                    ...
                                                                                    class="far fa-file-alt rotateY"></span></a>
                                                                    </td>
                                                                    <td class="tblTransaction-isCluster visibled"></td>
                                                                    <td class="tblsignal-SignalReason visibled"></td>
                                                ...
                                                <span class="buysell-span sell_type">
                                                    <b title=" Sell ">Sell</b> <span
                                                            ...
                                                            style="vertical-align:middle">
                                                                    ...
                                                                    <td class="1-mo c-1-mo visibled"><span
                                                                                style="color:#ff0000">-11%</span>
                                                                    </td>
                                                                    <td class="adj-1-mo hiddem"><span
                                                                                style="color:#ff0000">-7%</span></td>
                                                                    <td class="6-mo  c-6-mo visibled"></td>
                                                                    <td class="adj-6-mo hiddem"></td>
                                                                    <td class="9-mo c-9-mo hiddem"></td>
                                                                    <td class="adj-9-mo hiddem"></td>
                                                ...
                                                <span class="custom-control custom-checkbox custom-checkbox1  ">
                                                    ...
                                                    Mgr</span></td>
                                                                    ...
                                                                    <td class="1-mo c-1-mo visibled"><span
                                                                                style="color:#ff0000">-10%</span>
                                                                    </td>
                                                                    <td class="adj-1-mo hiddem"><span
                                                                                style="color:#ff0000">-5%</span></td>
                                                                    <td class="6-mo  c-6-mo visibled"></td>
                                                                    <td class="adj-6-mo hiddem"></td>
                                                                    <td class="9-mo c-9-mo hiddem"></td>
                                                                    <td class="adj-9-mo hiddem"></td>
